...
namespace LeagueDash.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public List<SelectListItem> PopulateDrowdown()
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            var isCaptain = user.PositionId == 2 || user.PositionId == 3 ? true : false;
